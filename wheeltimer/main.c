...
main(int argc, char **argv){
     ...
     * thread we created will also get terminated*/
                           wt_elem = 
        register_app_event(wt, wrapper_print_hello, "Abhishek", 
                           strlen("Abhishek"), 
                           7,  /*wrapper_print_hello fn will be called after every 5 seconds*/
                           1); /*1 indefinitely, 0 only once : call for wrapper_print_hello*/
    scanf("\n");
    return 0;
}
